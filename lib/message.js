...
function getAnswerWhichMatchEntitiesValues(answers, entities, entitiesValues){
  let answerMatchEntities = answers.find((a) => areArrayEqual(a.entValues, entities))
  let answerMatchEntitiesAndValues = answerMatchEntities.find((a) => areArrayEqual(a.entValues, entitiesValues))
  return answerMatchEntitiesAndValues
}
